...
<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-3 mx-auto md:h-screen lg:py-0">
      <div class="py-3">
        <h3>Default Use Email and Password</h3>
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form @submit.prevent="userLogin" class="space-y-4 md:space-y-6">
            <div>
            ...
            <button type="submit" class="text-white bg-indigo-500 hover:bg-indigo-600 border-2 border-indigo-400 px-8 py-2 rounded text-sm font-medium tracking-wide transition-colors duration-300 w-full">Sign in</button>
